 ...
 */
class RevisedSimplex (a: MatrixD, b: VectorD, c: VectorD, var x_B: VectorI = null)
      extends Error
{
     ...
     *  @param l  the variable choosen to enter the basis
     */
