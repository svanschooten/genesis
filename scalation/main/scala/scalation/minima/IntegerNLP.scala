...
import scalation.math.Vectors.{FunctionV2S, VectorI, VectorD}
 ...
 *  @param g     the constraint finction to be satisfied, if any
 *  @param excl  the set of variables to be excluded from the integer requirement 
 */
class IntegerNLP (f: FunctionV2S [Double], n: Int, var g: FunctionV2S [Double] = null, excl: Set [Int] = Set ())
{
