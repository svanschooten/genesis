...
import scalation.math.Calculus.{derivative}
 ...
 */
class WolfeLS (f: FunctionS2S [Double], c1: Double = .0001, c2: Double = .9)
{
     ...
     */
    def search (weak: Boolean = true): Double =
    {
        var lo  = 0.                                        // lower bound for x
        var x   = 1.                                        // current point
