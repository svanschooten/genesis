...
object Calculus
{
     ...
     *  your function.  A heuristic for the center difference method is to let
     ...
     */
    def resetH (step: Double) { h = step; h2 = h + h }
    ...
    //:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Estimate the derivative of the scalar-to-scalar function f at x using
     *  a 2-sided method (center difference).  Approximate the tangent line at
